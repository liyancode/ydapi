        ...
        def DAO_WHRawMaterialHistory.func_add(wh_raw_material_history)
          begin
            DAO_WHRawMaterialHistory.create do |obj|
              ...
              obj.inbound_count = wh_raw_material_history.inbound_count
              obj.inbound_weight = wh_raw_material_history.inbound_weight
              obj.inbound_unit_price = wh_raw_material_history.inbound_unit_price
              obj.inbound_total_price = wh_raw_material_history.inbound_total_price
              obj.inbound_from = wh_raw_material_history.inbound_from
              obj.inbound_principal = wh_raw_material_history.inbound_principal
              obj.inbound_at = wh_raw_material_history.inbound_at
              obj.outbound_count = wh_raw_material_history.outbound_count
              obj.outbound_weight = wh_raw_material_history.outbound_weight
              obj.outbound_unit_price = wh_raw_material_history.outbound_unit_price
              obj.outbound_total_price = wh_raw_material_history.outbound_total_price
              obj.outbound_to = wh_raw_material_history.outbound_to
              obj.outbound_principal = wh_raw_material_history.outbound_principal
              obj.outbound_at = wh_raw_material_history.outbound_at
